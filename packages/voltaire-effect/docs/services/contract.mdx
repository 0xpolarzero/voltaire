...
<Tip>
For applications with multiple contracts, use [makeContractRegistry](/services/contract-registry) to define all your contracts once and access them as a named map.
</Tip>
